...
- Wire compatibility with rust-libp2p's `/ipfs/kad/1.0.0`
...
Alpha. The protocol implementation has been tested against rust-libp2p 0.56 in interop scenarios and validated at scale in cluster deployments. APIs may shift before v1.0.
